                          ...
                          {obj.status === true ? (
                            <div>
                              ...
                              <div className="bookedIcon">
                                <img style={{height:100}} src="https://img.icons8.com/emoji/452/green-circle-emoji.png" onClick={() => {
                            ...
                            (<div className="">
                              ...
                              <img style={{height:100}} src="https://img.icons8.com/emoji/344/red-circle-emoji.png" 
                              onClick={async () => {
